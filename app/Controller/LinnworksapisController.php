			...
			if( isset($results) )
			 {
				...
				foreach($results as $data)
				{
					...
					if( isset($data->ShippingInfo->PostalServiceName) &&  $data->ShippingInfo->PostalServiceName == 'Express' && count($data->Items) > 0 && $data->Items[$i]->OrderItem->order_split == 'Group A')
					{
						$express1[]	=	$data;
					}
					else if( isset($data->ShippingInfo->PostalServiceName) &&  $data->ShippingInfo->PostalServiceName == 'Express' && count($data->Items) > 0 && $data->Items[$i]->OrderItem->order_split == 'Group B' )
					{
						$express2[]	=	$data ;						
					}
					if( isset($data->ShippingInfo->PostalServiceName) && ( $data->ShippingInfo->PostalServiceName == 'Standard' || $data->ShippingInfo->PostalServiceName == 'Default') && count($data->Items) > 0 && $data->Items[$i]->OrderItem->order_split == 'Group A')
					{
						$standerd1[]	=	 $data;						
					}
					else if( isset($data->ShippingInfo->PostalServiceName) && ($data->ShippingInfo->PostalServiceName == 'Standard' || $data->ShippingInfo->PostalServiceName == 'Default' ) && count($data->Items) > 0 && $data->Items[$i]->OrderItem->order_split == 'Group B' )
					{
						$standerd2[]	=	 $data;
					}
					if( isset($data->ShippingInfo->PostalServiceName) && $data->ShippingInfo->PostalServiceName == 'Tracked' && count($data->Items) > 0 && $data->Items[$i]->OrderItem->order_split == 'Group A')
					{
						$tracked1[]	=	 $data;
					}
					else if( isset($data->ShippingInfo->PostalServiceName) && $data->ShippingInfo->PostalServiceName == 'Tracked' && count($data->Items) > 0 && $data->Items[$i]->OrderItem->order_split == 'Group B')
					{
						$tracked2[]	=	 $data;
					}
					$i++;
